...
namespace MiniHosting.Data.Migrations
{
    ...
    [Migration("20231201171732_seed-data-for-new-table")]
    partial class seeddatafornewtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniHosting.Data.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MiniHosting.Data.Entities.AppRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MiniHosting.Data.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MiniHosting.Data.Entities.AppUserWebsite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsIncludeWww")
                        .HasColumnType("bit");

                    b.Property<bool>("IsTurnOnSSL")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AppUserWebsite");
                });

            modelBuilder.Entity("MiniHosting.Data.Entities.MstPermission", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MiniHosting.Data.Entities.AppRolePermission", b =>
                {
                    b.HasOne("MiniHosting.Data.Entities.AppRole", "AppRole")
                        .WithMany("AppRolePermissions")
                        .HasForeignKey("AppRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiniHosting.Data.Entities.MstPermission", "MstPermission")
                        .WithMany("AppRolePermissions")
